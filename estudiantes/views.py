...
class BitacoraEstudianteDetailView(LoginRequiredMixin, UserPassesTestMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['asignaturas'] = Asignatura.objects.all()
        context['logo_url'] = self.request.build_absolute_uri('https://static-educapro.s3.us-east-1.amazonaws.com/imagenes/LOGO+LICEO+TECNICO+ADULTOS.jpg')
...
class AnamnesisEstudianteUpdateView(UserPassesTestMixin, LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['logo_liceo_url'] = self.request.build_absolute_uri('https://static-educapro.s3.us-east-1.amazonaws.com/imagenes/LOGO+LICEO+TECNICO+ADULTOS.jpg')
        context['logo_servicio_url'] = self.request.build_absolute_uri('https://static-educapro.s3.us-east-1.amazonaws.com/imagenes/Servicio_local.jpg')
        context['logo_pie_url'] = self.request.build_absolute_uri('https://static-educapro.s3.us-east-1.amazonaws.com/imagenes/Imagen_PIE.jpg')
